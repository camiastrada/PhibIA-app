...
function Login() {
  ...
  return (
    <div className="flex flex-col lg:flex-row justify-center items-center md:min-h-4/5 md:w-4/5 w-full bg-white/85 border-2 border-white backdrop-blur-xs rounded-3xl p-4">
      ...
      <div className={openAvatarSelector ? "absolute flex w-full h-full justify-center items-center z-10" : "hidden"}>
        <AvatarSelector setOpenAvatarSelector={setOpenAvatarSelector}/>
      </div>

      <div id="content" className={`flex ${openAvatarSelector ? "blur-xl" : ""}`}>
